...
#if CHIP_WS63
    IOT_IO_NAME_GPIO_15, /* <GPIO15 */
    IOT_IO_NAME_GPIO_16, /* <GPIO16 */
    IOT_IO_NAME_GPIO_17, /* <GPIO17 */
    IOT_IO_NAME_GPIO_18, /* <GPIO18 */
#else
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_0_RESERVE = 2,
    IOT_IO_FUNC_GPIO_0_SPI1_CSN,
    IOT_IO_FUNC_GPIO_0_JTAG_TDI,
#else
    IOT_IO_FUNC_GPIO_0_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_1_RESERVE = 2,
    IOT_IO_FUNC_GPIO_1_SPI1_IO0_SO,
#else
    IOT_IO_FUNC_GPIO_1_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_2_RESERVE = 2,
    IOT_IO_FUNC_GPIO_2_SPI1_IO3,
#else
    IOT_IO_FUNC_GPIO_2_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_3_RESERVE,
    IOT_IO_FUNC_GPIO_3_IO1_S1,
#else
    IOT_IO_FUNC_GPIO_3_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_4_IO1_S1,
    IOT_IO_FUNC_GPIO_4_JTAG_ENABLE,
#else
    IOT_IO_FUNC_GPIO_4_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_5_UART2_CTS,
    IOT_IO_FUNC_GPIO_5_SPI1_IO2,
    IOT_IO_FUNC_GPIO_5_SPI0_IN,
#else
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_6_UART2_RTS = 2,
    IOT_IO_FUNC_GPIO_6_SPI1_SCK,
    IOT_IO_FUNC_GPIO_6_REFCLK_FREQ_STATUS,
    IOT_IO_FUNC_GPIO_6_RESERVE,
    IOT_IO_FUNC_GPIO_6_SPI0_OUT,
#else
    IOT_IO_FUNC_GPIO_6_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_7_UART2_RXD,
    IOT_IO_FUNC_GPIO_7_SPI0_SCK,
    IOT_IO_FUNC_GPIO_7_I2S_MCLK,
#else
    IOT_IO_FUNC_GPIO_7_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_8_UART2_TXD = 2,
    IOT_IO_FUNC_GPIO_8_SPI0_CS1_N,
    IOT_IO_FUNC_GPIO_8_RESERVE,
#else
    IOT_IO_FUNC_GPIO_8_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_9_RADAR_ANT0_SW,
    IOT_IO_FUNC_GPIO_9_SPI0_OUT,
    IOT_IO_FUNC_GPIO_9_I2S_DO,
    IOT_IO_FUNC_GPIO_9_RESERVE,
    IOT_IO_FUNC_GPIO_9_RESERVE1,
    IOT_IO_FUNC_GPIO_9_JTAG_TDO = 7,
#else
    IOT_IO_FUNC_GPIO_9_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_10_ANT0_SW,
    IOT_IO_FUNC_GPIO_10_SPI0_CS0_N,
    IOT_IO_FUNC_GPIO_10_I2S_SCLK,
#else
    IOT_IO_FUNC_GPIO_10_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_11_RADAR_ANT1_SW = 2,
    IOT_IO_FUNC_GPIO_11_SPI0_IN,
    IOT_IO_FUNC_GPIO_11_I2S_LRCLK,
#else
    IOT_IO_FUNC_GPIO_11_GPIO,
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_13_RADAR_ANT0_SW,
    IOT_IO_FUNC_GPIO_13_RESERVE,
    IOT_IO_FUNC_GPIO_13_JTAG_TMS_SWD,
#else
...
typedef enum {
    ...
    IOT_IO_FUNC_GPIO_14_RADAR_ANT1_SW,
    IOT_IO_FUNC_GPIO_14_RESERVE,
    IOT_IO_FUNC_GPIO_14_JTAG_TCK_SWC,
#else
...
* @ingroup iot_io
*
* GPIO_15 pin function.CNcomment:GPIO_15管脚功能。CNend
*/
typedef enum {
    IOT_IO_FUNC_GPIO_15_GPIO,
    IOT_IO_FUNC_GPIO_15_UART1_TXD,
    IOT_IO_FUNC_GPIO_15_I2C1_SDA,
} IotIoFuncGpio15;

/**
* @ingroup iot_io
*
* GPIO_16 pin function.CNcomment:GPIO_16管脚功能。CNend
*/
typedef enum {
    IOT_IO_FUNC_GPIO_16_GPIO,
    IOT_IO_FUNC_GPIO_16_UART1_RXD,
    IOT_IO_FUNC_GPIO_16_I2C1_SCL,
} IotIoFuncGpio16;
#else
/**
* @ingroup iot_io
